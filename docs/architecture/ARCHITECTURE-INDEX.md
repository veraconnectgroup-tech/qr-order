...
| [ADR-040](./ADR-040-unified-proactive-decision-spine.md) | **UPDS** — one loop/decider/emitter; Kad in offer fold; audit gate | **IMPLEMENTED** | Pilot: `upds_enforce_pilot` preset |
...
| [ADR-043](./ADR-043-denis-coworker-completion.md) | **Restaurant Co-worker completion** — Faza 1: station truth + Ops Center · Faza 2: tempo, 86, desert, stalni gost, recovery, obrt, brifing | **S0–S14 ✅** (pilot: `table_os_pilot`) | Operator: [ADR-043-operator](./ADR-043-operator.md) · [session-prompts](./ADR-043-session-prompts.md) |
| [ADR-044](./ADR-044-denis-loss-prevention.md) | **Owner Control & Loss Prevention** — journal osetljivih akcija, void/transfer/payment/keš/popust guardrails, owner suspicious report | **S1–S8 ✅** (pilot: `loss_prevention_pilot`) | [session-prompts](./ADR-044-session-prompts.md) |
| [ADR-045](./ADR-045-denis-memory-model.md) | **Multi-Memory Model** — Live/Shift/Restaurant/Audit nivoi, memory registar, Day Close, retencija, granice čitanja | **S1–S5 ✅** | [session-prompts](./ADR-045-session-prompts.md) |
| [ADR-046](./ADR-046-stabilization-freeze.md) | **Stabilization Freeze** — zamrzavanje funkcija, trijaža 78 nekomitovanih fajlova, 79 TS grešaka + 43 pala testa na nulu, živi bugovi, zlatan tok | **AKTIVAN — blokira sve nove funkcije** | [task-board](./ADR-046-task-board.md) · [agent-prompt](./ADR-046-agent-prompt.md) |
