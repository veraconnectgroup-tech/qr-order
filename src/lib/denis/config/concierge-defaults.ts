...
export const CONCIERGE_PLATFORM_DEFAULTS: ConciergeConfig = {
  ...
  ops: {
    ...
    unifiedOperationalContextCanaryPercent: 100,
    agenticToolLoop: {
      enabled: true,
      shadowOnly: false,
      canaryPercent: 100,
    ...
    stationQuestions: {
      ...
      // Still off: needs A3 (real-tablet listening test) before any venue
      // opens a live mic in a kitchen — a hardware-readiness gate, not a
      // capability restriction. Same reasoning for the Realtime rollout
      // below.
      handsFreeWakeWordEnabled: false,
      slaPreWarnEnabled: true,
      slaPreWarnMinutes: 5,
