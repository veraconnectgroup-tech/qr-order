...
function GuestPhoneShowcase() {
  return (
    <ShowcaseAmbientStage className="mx-auto w-full max-w-[220px] sm:max-w-[240px]">
  ...
  return (
    <>
      ...
      <FeatureRow
        ...
        reverse
        visual={
          <FeatureShowcase url="denis.app/dashboard/orders" aspect="16/11">
      ...
      <FeatureRow
        ...
        visual={
          <FeatureShowcase url="denis.app/dashboard/tables" aspect="16/11">
